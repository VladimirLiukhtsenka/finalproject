...
public class FormRegexValidator {
    ...
    public final static String LOGIN = "[\\wа-яА-ЯёЁ]{3,45}$";
    ...
    public final static String OPERATING_MODE = "^[\\p{Punct} \\wа-яА-ЯёЁ]{3,30}$";
    ...
    public final static String PHOTO = "(.*/)*.+/(png|jpg|bmp|jpeg|PNG|JPG|BMP|JPEG)$";
