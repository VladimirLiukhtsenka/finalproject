...
public class PagePath {
    ...
    public final static String PAGE_CREATE_EVENT = "/createevent.jsp";
    ...
    public final static String PAGE_FESTIVALS_EVENTS = "/allfestivalsevents.jsp";
    public final static String PAGE_FOR_CHILDREN_EVENTS = "/allforchildrenevents.jsp";
