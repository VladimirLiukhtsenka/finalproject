...
//    public static final String FORM_PARAM_MAIL = "mail";
    public static final String DEFAULT_VALUE = "\"\"";
//    public static final String FORM_PARAM_PHONE = "phone";
//    public static final String FORM_PARAM_NAME = "name";
//    public static final String FORM_PARAM_SURNAME = "surname";
//    public static final String FORM_PARAM_FATHER_NAME = "father name";
//    public static final String FORM_PARAM_GENDER = "gender";
    public static final String FORM_PARAM_ADD_EVENT = "addEvent";
    public static final String FORM_PARAM_DELETE_EVENT = "delete event";
//    public static final String FORM_PARAM_ADDRESS = "address";
//    public static final String FORM_PARAM_DESCRIPTION = "description";
//    public static final String FORM_PARAM_TYPE_EVENT = "type of event";
//    public static final String FORM_PARAM_DATE = "date";
