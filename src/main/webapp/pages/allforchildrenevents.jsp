...
<%@ include file="include/menu.jsp" %>
    <h1 align="center">FOR CHILDREN</h1>
    <div class="row">
    ...
    <table style = "margin: auto;padding: 0;">
            <tr>
                <c:if test="${currentPage != 1}">
                    <td><a href="do?command=View_for_children_event&page=${currentPage - 1}">Previous</a></td>
                </c:if>
                ...
                <c:if test="${currentPage < noOfPages}">
                    <td><a href="do?command=View_for_children_event&page=${currentPage + 1}">Next</a></td>
                </c:if>
            </tr>
    </table>
</body>
