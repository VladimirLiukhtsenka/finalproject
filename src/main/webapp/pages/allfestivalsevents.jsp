     ...
     <table style = "margin: auto;padding: 0;">
            <tr>
                <c:if test="${currentPage != 1}">
                    <td><a href="do?command=View_festivals_event&page=${currentPage - 1}"><fmt:message key="button.previous"/></a></td>
                </c:if>
                ...
                <c:if test="${currentPage < noOfPages}">
                    <td><a href="do?command=View_festivals_event&page=${currentPage + 1}"><fmt:message key="button.next"/></a></td>
                </c:if>
            </tr>
    </table>
</body>
