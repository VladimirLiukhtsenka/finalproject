...
<h1 align="center"><fmt:message key="button.createEvent"/></h1>
    <form class="form-horizontal"action = "do?command=create_event" method="POST" >
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="name" name="name" type="text" placeholder="" class="form-control input-md" required="" maxlength=45 pattern="^[\\p a-zA-Z_0-9а-яА-ЯёЁ]{3,45}$" >
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input id="description" name="description" type="text" placeholder="" class="form-control input-md" required="" maxlength=60 pattern="^[\\p a-zA-Z_0-9а-яА-ЯёЁ]{3,60}$">
            </div>
        </div>
